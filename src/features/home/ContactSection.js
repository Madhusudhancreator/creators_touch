          ...
          <div className="flex flex-col justify-between gap-8">
              ...
              {contactDetails.map(({ icon: Icon, label, value, href }) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {href ? (
                      <a href={href} className="text-white font-medium hover:text-[#0977a8] transition-colors">
                        {value}
                      </a>
                    ) : (
            ...
            <div className="p-6 rounded-2xl border border-white/10 bg-white/5">
              <p className="text-white/70 text-sm leading-relaxed">
                From brand strategy to digital execution — we craft experiences that make your business stand out. Let&apos;s build something remarkable together.
              </p>
